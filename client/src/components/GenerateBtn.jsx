...
const { user, setShowLogin } = useContext(AppContext);
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='pb-16 text-center *:first-letter'>
      <h1 className='text-2xl md:text-3xl lg:text-4xl
      mt-4 font-semibold text-netural-800 py-6
...
transition-all duration-500'>Generate Images <img src={assets.star_group} alt="" className='h-6'/>
</button>
