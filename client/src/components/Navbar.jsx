...
<div className='flex items-center gap-2 sm:gap-5'> 
    ...
    hover:scale-105 transtion-all duration-700'>  
        <img className='w-5' src={assets.credit_star} alt="" />
     <p className='text-xs sm-text-sm font font-medium
     text-gray-450'>credits left:{credits}</p> 
     </button>
...
:
<div className='flex items-center gap-2 sm:gap-5'> 
    <p onClick={()=>navigate('/buy-credits')}
